...
import Petra.modules.fun_strings as fun_strings
...
@run_async
def knife(update: Update, context: CallbackContext):
    message = update.effective_message
    name = message.reply_to_message.from_user.first_name if message.reply_to_message else message.from_user.first_name
    reply_animation = message.reply_to_message.reply_animation if message.reply_to_message else message.reply_animation
    reply_animation(
...
__help__ = """
 ...
 • `/knife`*:* scare someone with a knife!
...
KNIFE_HANDLER = DisableAbleCommandHandler("knife", knife)
...
dispatcher.add_handler(KNIFE_HANDLER)

__mod_name__ = "Fun"
__command_list__ = [
    "runs", "slap", "roll", "toss", "shrug", "bluetext", "rlg", "decide",
    "table", "pat", "sanitize", "shout", "weebify", "anifact", "knife"
]
__handlers__ = [
    ...
    SANITIZE_HANDLER, SHOUT_HANDLER, WEEBIFY_HANDLER, ANIFACT_HANDLER, KNIFE_HANDLER
]
