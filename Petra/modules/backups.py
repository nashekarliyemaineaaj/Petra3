...
import Petra.modules.sql.notes_sql as sql
from Petra import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Petra.__main__ import DATA_IMPORT
from Petra.modules.helper_funcs.chat_status import user_admin
from Petra.modules.helper_funcs.alternate import typing_action

# from Petra.modules.rules import get_rules
import Petra.modules.sql.rules_sql as rulessql

# from Petra.modules.sql import warns_sql as warnssql
import Petra.modules.sql.blacklist_sql as blacklistsql
from Petra.modules.sql import disable_sql as disabledsql

# from Petra.modules.sql import cust_filters_sql as filtersql
# import Petra.modules.sql.welcome_sql as welcsql
import Petra.modules.sql.locks_sql as locksql
from Petra.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("Petra {}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Petra {}.backup".format(chat_id), "rb"),
    ...
    os.remove("Petra {}.backup".format(chat_id))  # Cleaning file
